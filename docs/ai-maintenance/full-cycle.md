...
4. Commit, push, and deploy the resulting checkpoint with `npm run ship -- "Context-rich commit message"`; include what changed, why it matters, and verification performed.
